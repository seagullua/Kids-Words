...
project.package_name = 'com.x4enjoy.kidswords.russian'
...
project.signature = createAndroidSignature('Resources_storage/android/build.android/key.jks',
											'mavka',
                                           '', '')
project.res_dir = 'Resources_storage/android/build.android/res.ru'
...
project.addCppDir('Versions/Language/Russian')
